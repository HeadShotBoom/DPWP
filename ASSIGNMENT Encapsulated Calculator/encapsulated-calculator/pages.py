...
<html>
    ...
    def current_camera(self, new_cameras):
        ...
        self.__display = """
            <article>
                <p>Current Camera Name is: {self.current_camera.name} </p>
            ...
            <aside>
                ...
                <div>
                    <img class='article' src='{self.lens_package}' alt='Lens Pic' />
                    <img class='article' src='{self.accessories_package}' alt='Lens Pic' />
                </div>
